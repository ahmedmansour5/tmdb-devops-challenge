...
1. The developer pushes code to the develop branch as main branch is disabled for direct pushes for security.
2. After review by at least 2 reviewers, the code can be merged to main.
3. GitHub Actions/Jenkins Server run the CI pipeline to integrate and test the approved code.
4. Once completed successfully, the pipeline deploys the updated code on the 2 backend servers one by one.
